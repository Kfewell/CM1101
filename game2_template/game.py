...
def list_of_items(items):
    ...
    """
    pass
    return ", ".join(items["name"] for items in items)
...
def print_room_items(room):
    ...
    """
    pass
    if not list_of_items(room["items"]) == "":
...
def print_inventory_items(items):
    ...
    """
    pass
    if not (list_of_items(inventory)==""):
